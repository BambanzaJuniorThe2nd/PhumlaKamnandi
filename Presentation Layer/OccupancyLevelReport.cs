...
namespace PhumlaKamnandi.Presentation_Layer
{
    public partial class OccupancyLevelReport : Form
    {
        ...
        public OccupancyLevelReport(Reserve reserve)
        {
            InitializeComponent();
        ...
        private void setupOccupancyLevelsListview()
        {
            ...
            listViewOccupancy.Clear();
            listViewOccupancy.Columns.Insert(0, "Guest Name", 120, HorizontalAlignment.Left);
            listViewOccupancy.Columns.Insert(1, "Checkin", 120, HorizontalAlignment.Left);
            listViewOccupancy.Columns.Insert(2, "Checkout", 120, HorizontalAlignment.Left);
            listViewOccupancy.Columns.Insert(3, "Avg Rate", 120, HorizontalAlignment.Left);
            listViewOccupancy.Columns.Insert(4, "Total", 120, HorizontalAlignment.Left);

            listViewOccupancy.Refresh();
            listViewOccupancy.GridLines = true;
        }
        ...
        private void OccupancyLevelReport_Load(object sender, EventArgs e)
        {
            ...
            listViewOccupancy.View = View.Details;
        }
        ...
        private void buttonConfirm_Click(object sender, EventArgs e)
        {
            ...
            foreach (Booking booking in occupancies)
            {
                ...
                listViewOccupancy.Items.Add(occupancydetails);
            }
